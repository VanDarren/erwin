...
<li class="nav-item mt-2">
      ...
      ?>
        ...
        <li class="nav-item border-start my-0 pt-2">
          <a class="nav-link position-relative ms-0 ps-2 py-2 " href="<?= base_url('home/profile/'.$satu->id_user)?>">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="dropdown d-inline">
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="<?= base_url('img/'.$satu->foto)?>" alt="Profile" class="rounded-circle me-2" style="width: 80px;">
        </a>
<!-- </li> -->
        <ul class="dropdown-menu dropdown-menu-end">
            <li><a class="dropdown-item" href="<?= base_url('home/profile/'.$satu->id_user)?>">My Profile</a></li>
