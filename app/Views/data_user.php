<div class="pagetitle">
	...
	<a href="<?= base_url("home/t_duser")?>">
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th align="center" scope="col">Phone Number</th>
        ...
        <a href="<?= base_url('home/e_duser/'.$wkwk->id_user) ?>">
    <button class="btn btn-warning">
        <i class="fas fa-pen"></i>
    </button>
</a>

			<a href="<?= base_url('home/hapus_duser/'.$wkwk->id_user) ?>">
