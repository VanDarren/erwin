<div class="pagetitle">
      <h1 align="center">Data Kantor</h1>
      <nav>
        <ol class="breadcrumb">
	...
	<a href="<?= base_url("home/t_dkantor")?>">
        ...
        <a href="<?= base_url('home/e_dkantor/'.$wkwk->id_kantor) ?>">
    <button class="btn btn-warning">
        <i class="fas fa-pen"></i>
    </button>
</a>

			<a href="<?= base_url('home/hapus_dkantor/'.$wkwk->id_kantor) ?>">
