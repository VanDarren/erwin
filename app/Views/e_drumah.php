<main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <li class="breadcrumb-item"><a href="<?= base_url('home/data_rumah')?>">Rumah</a></li>
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?=base_url('home/aksi_e_drumah')?>"method="POST" enctype="multipart/form-data">  
              ...
              <div class="mb-3 mt-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <input type="hidden" name="id" value="<?= $dua->id_rumah ?>">
                  </div>
                </div>
